    ...
    return (
      <div>
          ...
          <Grid.Column>
            <div id="button">
              <Link to="/profile-edit" id="the-btn">
                <button id="profile-edit" className="ui basic black button">Edit profile</button>
              </Link>
            </div>
            <Image
        ...
        <Table basic="very" celled collapsing id="pull-right">
          ...
          <Table.Body>
            <Table.Row>
              <Table.Cell className="yellow-with-large-padding">First Name</Table.Cell>
              <Table.Cell>{userProfile.First_name} </Table.Cell>
            </Table.Row>
            <Table.Row>
              <Table.Cell className="yellow-with-large-padding">Last Name</Table.Cell>
              <Table.Cell>{userProfile.Last_name}</Table.Cell>
            </Table.Row>
            <Table.Row>
              <Table.Cell className="yellow-with-large-padding">Location</Table.Cell>
            ...
            <Table.Row>
              <Table.Cell className="yellow-with-large-padding">Company</Table.Cell>
